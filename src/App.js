...
const App = () => (
    <div id="wrapper">
        <ul className="navbar-nav bg-secondary sidebar">
            ...
            <li className="nav-item">
                <a className="nav-link digital-tv" href="#">
                    <span>Digital TV</span>
                </a>
            </li>     
            
            <li className="nav-item">
                <a className="nav-link home-monitoring" href="#">
                    <span>Home Monitoring</span>
                </a>
            </li>
            
            <li className="nav-item">
                <a className="nav-link home-phone" href="#">
                    <span>Home Phone</span>
                </a>
            </li>
            
            <li className="nav-item">
                <a className="nav-link ignite-tv" href="#">
                    <span>Ignite TV</span>
                </a>
            </li>
            
            <li className="nav-item">
                <a className="nav-link internet" href="#">
                    <span>Internet</span>
                </a>
            </li>
            
            <li className="nav-item">
                <a className="nav-link wireless" href="#">
                    <span>Wireless</span>
                </a>
            </li>    
            ...
            <div className="text-center d-none d-md-inline">
                <button className="rounded-circle border-0 sidebar-toggle"></button>
            </div>
        </ul>
